  ...
  white: {
    early: {
      short: [
        ...
        { text: "了解しました",           reading: "りょうかいしました",           lengthType: "short" },
        { text: "おはようございます",     reading: "おはようございます",           lengthType: "short" },
        { text: "お待ちしております",     reading: "おまちしております",           lengthType: "short" },
        { text: "お疲れ様でした",         reading: "おつかれさまでした",           lengthType: "short" },
        { text: "受け取りました",         reading: "うけとりました",               lengthType: "short" },
        { text: "ただいま参ります",       reading: "ただいままいります",           lengthType: "short" },
        { text: "承りました",             reading: "うけたまわりました",           lengthType: "short" }
      ],
    },
    middle: {
      short: [
        ...
        { text: "確認できました",     reading: "かくにんできました",       lengthType: "short" },
        { text: "少々お待ちください", reading: "しょうしょうおまちください", lengthType: "short" },
        { text: "了解です",           reading: "りょうかいです",           lengthType: "short" },
        { text: "調整します",         reading: "ちょうせいします",         lengthType: "short" },
        { text: "ご報告します",       reading: "ごほうこくします",         lengthType: "short" },
        { text: "手が空きました",     reading: "てがあきました",           lengthType: "short" }
      ],
      medium: [
        ...
        { text: "ご確認のほどよろしくお願いします",     reading: "ごかくにんのほどよろしくおねがいします",       lengthType: "medium" },
        { text: "本日中にご回答いたします",             reading: "ほんじつちゅうにごかいとういたします",         lengthType: "medium" },
        { text: "先ほどの件を確認中です",               reading: "さきほどのけんをかくにんちゅうです",           lengthType: "medium" },
        { text: "追って詳細をお伝えします",             reading: "おってしょうさいをおつたえします",             lengthType: "medium" },
        { text: "内容を整理してご連絡します",           reading: "ないようをせいりしてごれんらくします",         lengthType: "medium" },
        { text: "お手数ですがご確認をお願いします",     reading: "おてすうですがごかくにんをおねがいします",     lengthType: "medium" },
        { text: "担当者に確認してご連絡します",         reading: "たんとうしゃにかくにんしてごれんらくします",   lengthType: "medium" }
      ],
    },
    late: {
      short: [
        ...
        { text: "お先に失礼します",       reading: "おさきにしつれいします",   lengthType: "short" },
        { text: "ありがとうございました", reading: "ありがとうございました",   lengthType: "short" },
        { text: "お疲れ様でした",         reading: "おつかれさまでした",       lengthType: "short" }
      ],
      medium: [
        ...
        { text: "本日もお疲れ様でした",           reading: "ほんじつもおつかれさまでした",         lengthType: "medium" },
        { text: "無事対応が完了しました",         reading: "ぶじたいおうがかんりょうしました",     lengthType: "medium" },
        { text: "引き続きよろしくお願いします",   reading: "ひきつづきよろしくおねがいします",     lengthType: "medium" },
        { text: "問題なく完了しました",           reading: "もんだいなくかんりょうしました",       lengthType: "medium" }
      ],
    }
  },
  ...
  normal: {
    early: {
      short: [
        ...
        { text: "了解しました",           reading: "りょうかいしました",       lengthType: "short" },
        { text: "承知しました",           reading: "しょうちしました",         lengthType: "short" },
        { text: "確認して折り返します",   reading: "かくにんしておりかえします", lengthType: "short" },
        { text: "少し確認させてください", reading: "すこしかくにんさせてください", lengthType: "short" }
      ],
      medium: [
        ...
        { text: "先ほどの件で修正が入りました",     reading: "さきほどのけんでしゅうせいがはいりました",   lengthType: "medium" },
        { text: "確認次第ご連絡します",             reading: "かくにんしだいごれんらくします",             lengthType: "medium" },
        { text: "本件関係者に共有しました",         reading: "ほんけんかんけいしゃにきょうゆうしました",   lengthType: "medium" },
        { text: "資料の準備が整いました",           reading: "しりょうのじゅんびがととのいました",         lengthType: "medium" },
        { text: "打ち合わせの時間を変更します",     reading: "うちあわせのじかんをへんこうします",         lengthType: "medium" }
      ],
    },
    middle: {
      short: [
        ...
        { text: "確認します",       reading: "かくにんします",         lengthType: "short" },
        { text: "追って連絡します", reading: "おってれんらくします",   lengthType: "short" },
        { text: "調整します",       reading: "ちょうせいします",       lengthType: "short" },
        { text: "差し替えます",     reading: "さしかえます",           lengthType: "short" },
        { text: "先に対応します",   reading: "さきにたいおうします",   lengthType: "short" },
        { text: "一度確認します",   reading: "いちどかくにんします",   lengthType: "short" }
      ],
      medium: [
        ...
        { text: "本件少々お時間をいただけますか",         reading: "ほんけんしょうしょうおじかんをいただけますか",   lengthType: "medium" },
        { text: "内容を確認してから対応します",           reading: "ないようをかくにんしてからたいおうします",       lengthType: "medium" },
        { text: "担当者に確認してから回答します",         reading: "たんとうしゃにかくにんしてからかいとうします",   lengthType: "medium" },
        { text: "一度社内で調整が必要です",               reading: "いちどしゃないでちょうせいがひつようです",       lengthType: "medium" },
        { text: "修正点を共有してから進めます",           reading: "しゅうせいてんをきょうゆうしてからすすめます",   lengthType: "medium" },
        { text: "こちらで対応できるか確認します",         reading: "こちらでたいおうできるかかくにんします",         lengthType: "medium" },
        { text: "先方への確認が取れ次第連絡します",       reading: "せんぽうへのかくにんがとれしだいれんらくします", lengthType: "medium" },
        { text: "期日を再確認します",                     reading: "きじつをさいかくにんします",                     lengthType: "medium" }
      ],
    },
    late: {
      medium: [
        ...
        { text: "内容を確認の上送付します",         reading: "ないようをかくにんのうえそうふします",           lengthType: "medium" },
        { text: "先方の確認が取れました",           reading: "せんぽうのかくにんがとれました",               lengthType: "medium" },
        { text: "最終確認中です少々お待ちください", reading: "さいしゅうかくにんちゅうですしょうしょうおまちください", lengthType: "medium" },
        { text: "本日中に最終版をお送りします",     reading: "ほんじつちゅうにさいしゅうばんをおおくりします", lengthType: "medium" }
      ],
      long: [
        ...
        { text: "修正箇所を反映しましたので改めてご確認をお願いいたします",     reading: "しゅうせいかしょをはんえいしましたのであらためてごかくにんをおねがいいたします", lengthType: "long" },
        { text: "添付資料の内容を修正しましたのでこちらをご確認ください",       reading: "てんぷしりょうのないようをしゅうせいしましたのでこちらをごかくにんください",   lengthType: "long" },
        { text: "ご迷惑をおかけしましたが対応が完了しましたのでご確認をお願いします", reading: "ごめいわくをおかけしましたがたいおうがかんりょうしましたのでごかくにんをおねがいします", lengthType: "long" },
        { text: "こちらの件は本日中に対応が必要ですので優先してください",             reading: "こちらのけんはほんじつちゅうにたいおうがひつようですのでゆうせんしてください",             lengthType: "long" },
        { text: "先ほどの資料に不備がございましたので改めてご確認をお願いします",     reading: "さきほどのしりょうにふびがございましたのであらためてごかくにんをおねがいします",         lengthType: "long" },
        { text: "お手数ですが本日の作業報告を終業前にご送信ください",                 reading: "おてすうですがほんじつのさぎょうほうこくをしゅうぎょうまえにごそうしんください",         lengthType: "long" }
      ]
    }
  },
  ...
  black: {
    early: {
      medium: [
        ...
        { text: "急ぎで対応してください",       reading: "いそぎでたいおうしてください",         lengthType: "medium" },
        { text: "今日絶対終わらせてください",   reading: "きょうぜったいおわらせてください",     lengthType: "medium" },
        { text: "先方が待っています",           reading: "せんぽうがまっています",               lengthType: "medium" },
        { text: "これ今日の最優先です",         reading: "これきょうのさいゆうせんです",         lengthType: "medium" },
        { text: "全部今日中に終わらせて",       reading: "ぜんぶきょうじゅうにおわらせて",       lengthType: "medium" }
      ],
    },
    middle: {
      medium: [
        ...
        { text: "まだやってないんですか",     reading: "まだやってないんですか",         lengthType: "medium" },
        { text: "今すぐやってください",       reading: "いますぐやってください",         lengthType: "medium" },
        { text: "これ誰がやるんですか",       reading: "これだれがやるんですか",         lengthType: "medium" },
        { text: "早くしてください",           reading: "はやくしてください",             lengthType: "medium" },
        { text: "もう時間ないですよ",         reading: "もうじかんないですよ",           lengthType: "medium" },
        { text: "それより先にこれやって",     reading: "それよりさきにこれやって",       lengthType: "medium" },
        { text: "いつ終わるんですか",         reading: "いつおわるんですか",             lengthType: "medium" },
        { text: "何やってるんですか",         reading: "なにやってるんですか",           lengthType: "medium" }
      ],
      long: [
        ...
        { text: "先ほどの会議で指摘された点をすぐに修正して送ってください",       reading: "さきほどのかいぎでしてきされたてんをすぐにしゅうせいしておくってください",     lengthType: "long" },
        { text: "お客様から問い合わせが来ているので早急に回答をお願いします",     reading: "おきゃくさまからといあわせがきているのでさっきゅうにかいとうをおねがいします", lengthType: "long" },
        { text: "明日の朝一の会議までに資料を仕上げてください",                   reading: "あしたのあさいちのかいぎまでにしりょうをしあげてください",                   lengthType: "long" },
        { text: "今すぐ状況を報告してから作業を再開してください",                 reading: "いますぐじょうきょうをほうこくしてからさぎょうをさいかいしてください",         lengthType: "long" }
      ]
    },
    late: {
      medium: [
        ...
        { text: "まだ確認取れてないんですか",     reading: "まだかくにんとれてないんですか",       lengthType: "medium" },
        { text: "全部最初からやり直してください", reading: "ぜんぶさいしょからやりなおしてください", lengthType: "medium" },
        { text: "今すぐ確認して報告してください", reading: "いますぐかくにんしてほうこくしてください", lengthType: "medium" },
        { text: "残業してでも終わらせてください", reading: "ざんぎょうしてでもおわらせてください",   lengthType: "medium" }
      ],
      long: [
        ...
        { text: "なんでこんなに時間がかかってるんですかもう一度最初から確認してください",   reading: "なんでこんなにじかんがかかってるんですかもういちどさいしょからかくにんしてください",   lengthType: "long" },
        { text: "お客様への返答が遅れているので今すぐ修正版を送ってください",               reading: "おきゃくさまへのへんとうがおくれているのでいますぐしゅうせいばんをおくってください",   lengthType: "long" },
        { text: "上司から確認が入っているので今すぐ状況を報告してください",                 reading: "じょうしからかくにんがはいっているのでいますぐじょうきょうをほうこくしてください",     lengthType: "long" },
        { text: "今日の作業が全部終わっていないのであれば理由を今すぐ説明してください",     reading: "きょうのさぎょうがぜんぶおわっていないのであればりゆうをいますぐせつめいしてください", lengthType: "long" },
        { text: "今すぐ確認して何が問題なのかをすぐに報告してください",                   reading: "いますぐかくにんしてなにがもんだいなのかをすぐにほうこくしてください",                   lengthType: "long" },
        { text: "何度も言いますがこの品質では客先に出せないのでやり直してください",         reading: "なんどもいいますがこのひんしつではきゃくさきにだせないのでやりなおしてください",         lengthType: "long" },
        { text: "まだ終わっていないんですかもう退社時間はとっくに過ぎていますよ",           reading: "まだおわっていないんですかもうたいしゃじかんはとっくにすぎていますよ",                   lengthType: "long" }
      ]
    }
  }
};
...
["すみません本日中に対応お願いします", [["本","ほん"],["日","じつ"],["中","ちゅう"],["対","たい"],["応","おう"],["願","ねが"]]],
  ...
  // ホワイト企業 middle/short
  ["確認できました", [["確","かく"],["認","にん"]]],
  ["少々お待ちください", [["少","しょう"],["々","しょう"],["待","ま"]]],
  ["了解です", [["了","りょう"],["解","かい"]]],
  ["調整します", [["調","ちょう"],["整","せい"]]],
  ["ご報告します", [["報","ほう"],["告","こく"]]],
  ["手が空きました", [["手","て"],["空","あ"]]],
  // ホワイト企業 middle/medium
  ["ご確認のほどよろしくお願いします", [["確","かく"],["認","にん"],["願","ねが"]]],
  ["本日中にご回答いたします", [["本","ほん"],["日","じつ"],["中","ちゅう"],["回","かい"],["答","とう"]]],
  ["先ほどの件を確認中です", [["先","さき"],["件","けん"],["確","かく"],["認","にん"],["中","ちゅう"]]],
  ["追って詳細をお伝えします", [["追","お"],["詳","しょう"],["細","さい"],["伝","つた"]]],
  ["内容を整理してご連絡します", [["内","ない"],["容","よう"],["整","せい"],["理","り"],["連","れん"],["絡","らく"]]],
  ["お手数ですがご確認をお願いします", [["手","て"],["数","すう"],["確","かく"],["認","にん"],["願","ねが"]]],
  ["担当者に確認してご連絡します", [["担","たん"],["当","とう"],["者","しゃ"],["確","かく"],["認","にん"],["連","れん"],["絡","らく"]]],
  // ホワイト企業 late/short
  ["お先に失礼します", [["先","さき"],["失","しつ"],["礼","れい"]]],
  ["ありがとうございました", []],
  // ホワイト企業 late/medium
  ["本日もお疲れ様でした", [["本","ほん"],["日","じつ"],["疲","つか"],["様","さま"]]],
  ["無事対応が完了しました", [["無","ぶ"],["事","じ"],["対","たい"],["応","おう"],["完","かん"],["了","りょう"]]],
  ["引き続きよろしくお願いします", [["引","ひ"],["続","つづ"],["願","ねが"]]],
  ["問題なく完了しました", [["問","もん"],["題","だい"],["完","かん"],["了","りょう"]]],
  // ふつうの企業 early/short
  ["確認して折り返します", [["確","かく"],["認","にん"],["折","お"],["返","かえ"]]],
  ["少し確認させてください", [["少","すこ"],["確","かく"],["認","にん"]]],
  // ふつうの企業 early/medium
  ["先ほどの件で修正が入りました", [["先","さき"],["件","けん"],["修","しゅう"],["正","せい"],["入","はい"]]],
  ["確認次第ご連絡します", [["確","かく"],["認","にん"],["次","し"],["第","だい"],["連","れん"],["絡","らく"]]],
  ["本件関係者に共有しました", [["本","ほん"],["件","けん"],["関","かん"],["係","けい"],["者","しゃ"],["共","きょう"],["有","ゆう"]]],
  ["資料の準備が整いました", [["資","し"],["料","りょう"],["準","じゅん"],["備","び"],["整","ととの"]]],
  ["打ち合わせの時間を変更します", [["打","う"],["合","あわ"],["時","じ"],["間","かん"],["変","へん"],["更","こう"]]],
  // ふつうの企業 middle/short
  ["確認します", [["確","かく"],["認","にん"]]],
  ["追って連絡します", [["追","お"],["連","れん"],["絡","らく"]]],
  ["差し替えます", [["差","さ"],["替","か"]]],
  ["先に対応します", [["先","さき"],["対","たい"],["応","おう"]]],
  ["一度確認します", [["一","いち"],["度","ど"],["確","かく"],["認","にん"]]],
  // ふつうの企業 middle/medium
  ["本件少々お時間をいただけますか", [["本","ほん"],["件","けん"],["少","しょう"],["々","しょう"],["時","じ"],["間","かん"]]],
  ["内容を確認してから対応します", [["内","ない"],["容","よう"],["確","かく"],["認","にん"],["対","たい"],["応","おう"]]],
  ["担当者に確認してから回答します", [["担","たん"],["当","とう"],["者","しゃ"],["確","かく"],["認","にん"],["回","かい"],["答","とう"]]],
  ["一度社内で調整が必要です", [["一","いち"],["度","ど"],["社","しゃ"],["内","ない"],["調","ちょう"],["整","せい"],["必","ひつ"],["要","よう"]]],
  ["修正点を共有してから進めます", [["修","しゅう"],["正","せい"],["点","てん"],["共","きょう"],["有","ゆう"],["進","すす"]]],
  ["こちらで対応できるか確認します", [["対","たい"],["応","おう"],["確","かく"],["認","にん"]]],
  ["先方への確認が取れ次第連絡します", [["先","せん"],["方","ぽう"],["確","かく"],["認","にん"],["取","と"],["次","し"],["第","だい"],["連","れん"],["絡","らく"]]],
  ["期日を再確認します", [["期","き"],["日","じつ"],["再","さい"],["確","かく"],["認","にん"]]],
  // ふつうの企業 late/medium
  ["内容を確認の上送付します", [["内","ない"],["容","よう"],["確","かく"],["認","にん"],["上","うえ"],["送","そう"],["付","ふ"]]],
  ["先方の確認が取れました", [["先","せん"],["方","ぽう"],["確","かく"],["認","にん"],["取","と"]]],
  ["最終確認中です少々お待ちください", [["最","さい"],["終","しゅう"],["確","かく"],["認","にん"],["中","ちゅう"],["少","しょう"],["々","しょう"],["待","ま"]]],
  ["本日中に最終版をお送りします", [["本","ほん"],["日","じつ"],["中","ちゅう"],["最","さい"],["終","しゅう"],["版","ばん"]]],
  // ふつうの企業 late/long
  ["修正箇所を反映しましたので改めてご確認をお願いいたします", [["修","しゅう"],["正","せい"],["箇","か"],["所","しょ"],["反","はん"],["映","えい"],["改","あらた"],["確","かく"],["認","にん"],["願","ねが"]]],
  ["添付資料の内容を修正しましたのでこちらをご確認ください", [["添","てん"],["付","ぷ"],["資","し"],["料","りょう"],["内","ない"],["容","よう"],["修","しゅう"],["正","せい"],["確","かく"],["認","にん"]]],
  ["ご迷惑をおかけしましたが対応が完了しましたのでご確認をお願いします", [["迷","めい"],["惑","わく"],["対","たい"],["応","おう"],["完","かん"],["了","りょう"],["確","かく"],["認","にん"],["願","ねが"]]],
  ["こちらの件は本日中に対応が必要ですので優先してください", [["件","けん"],["本","ほん"],["日","じつ"],["中","ちゅう"],["対","たい"],["応","おう"],["必","ひつ"],["要","よう"],["優","ゆう"],["先","せん"]]],
  ["先ほどの資料に不備がございましたので改めてご確認をお願いします", [["先","さき"],["資","し"],["料","りょう"],["不","ふ"],["備","び"],["改","あらた"],["確","かく"],["認","にん"],["願","ねが"]]],
  ["お手数ですが本日の作業報告を終業前にご送信ください", [["本","ほん"],["日","じつ"],["作","さ"],["業","ぎょう"],["報","ほう"],["告","こく"],["終","しゅう"],["業","ぎょう"],["前","まえ"],["送","そう"],["信","しん"]]],
  // ブラック企業 early/medium
  ["急ぎで対応してください", [["急","いそ"],["対","たい"],["応","おう"]]],
  ["今日絶対終わらせてください", [["今","きょ"],["日","う"],["絶","ぜっ"],["対","たい"],["終","お"]]],
  ["先方が待っています", [["先","せん"],["方","ぽう"],["待","ま"]]],
  ["これ今日の最優先です", [["今","きょ"],["日","う"],["最","さい"],["優","ゆう"],["先","せん"]]],
  ["全部今日中に終わらせて", [["全","ぜん"],["部","ぶ"],["今","きょ"],["日","う"],["中","じゅう"],["終","お"]]],
  // ブラック企業 middle/medium
  ["まだやってないんですか", []],
  ["今すぐやってください", [["今","いま"]]],
  ["これ誰がやるんですか", [["誰","だれ"]]],
  ["早くしてください", [["早","はや"]]],
  ...
  ["何やってるんですか", [["何","なに"]]],
  // ブラック企業 middle/long
  ["先ほどの会議で指摘された点をすぐに修正して送ってください", [["先","さき"],["会","かい"],["議","ぎ"],["指","し"],["摘","てき"],["点","てん"],["修","しゅう"],["正","せい"],["送","おく"]]],
  ["お客様から問い合わせが来ているので早急に回答をお願いします", [["客","きゃく"],["様","さま"],["問","と"],["合","あわ"],["早","さっ"],["急","きゅう"],["回","かい"],["答","とう"],["願","ねが"]]],
  ["明日の朝一の会議までに資料を仕上げてください", [["明","あ"],["日","した"],["朝","あさ"],["一","いち"],["会","かい"],["議","ぎ"],["資","し"],["料","りょう"],["仕","し"],["上","あ"]]],
  ["今すぐ状況を報告してから作業を再開してください", [["今","いま"],["状","じょう"],["況","きょう"],["報","ほう"],["告","こく"],["作","さ"],["業","ぎょう"],["再","さい"],["開","かい"]]],
  // ブラック企業 late/medium
  ["まだ確認取れてないんですか", [["確","かく"],["認","にん"],["取","と"]]],
  ["全部最初からやり直してください", [["全","ぜん"],["部","ぶ"],["最","さい"],["初","しょ"],["直","なお"]]],
  ["今すぐ確認して報告してください", [["今","いま"],["確","かく"],["認","にん"],["報","ほう"],["告","こく"]]],
  ["残業してでも終わらせてください", [["残","ざん"],["業","ぎょう"],["終","お"]]],
  // ブラック企業 late/long
  ["なんでこんなに時間がかかってるんですかもう一度最初から確認してください", [["時","じ"],["間","かん"],["一","いち"],["度","ど"],["最","さい"],["初","しょ"],["確","かく"],["認","にん"]]],
  ["お客様への返答が遅れているので今すぐ修正版を送ってください", [["客","きゃく"],["様","さま"],["返","へん"],["答","とう"],["遅","おく"],["今","いま"],["修","しゅう"],["正","せい"],["版","ばん"],["送","おく"]]],
  ["上司から確認が入っているので今すぐ状況を報告してください", [["上","じょう"],["司","し"],["確","かく"],["認","にん"],["入","はい"],["今","いま"],["状","じょう"],["況","きょう"],["報","ほう"],["告","こく"]]],
  ["今日の作業が全部終わっていないのであれば理由を今すぐ説明してください", [["今","きょ"],["日","う"],["作","さ"],["業","ぎょう"],["全","ぜん"],["部","ぶ"],["終","お"],["理","り"],["由","ゆう"],["今","いま"],["説","せつ"],["明","めい"]]],
  ["今すぐ確認して何が問題なのかをすぐに報告してください", [["確","かく"],["認","にん"],["何","なに"],["問","もん"],["題","だい"],["報","ほう"],["告","こく"]]],
  ["何度も言いますがこの品質では客先に出せないのでやり直してください", [["何","なん"],["度","ど"],["品","ひん"],["質","しつ"],["客","きゃく"],["先","さき"],["出","だ"],["直","なお"]]],
  ["まだ終わっていないんですかもう退社時間はとっくに過ぎていますよ", [["終","お"],["退","たい"],["社","しゃ"],["時","じ"],["間","かん"],["過","す"]]],
]);
...
function updateStats() {
  ...
  if (!session.milestone50 && pct >= 50) {
    ...
    showMilestoneFlash("業務折り返し", "half");
